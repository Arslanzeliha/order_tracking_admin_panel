<?php include 'transactions/process.php' ;
...
<head>
  ...
  <meta name="description" content="<?php echo $ayarcek['site_explanation'] ?>">
  <meta name="author" content="<?php echo $ayarcek['site_owner'] ?>">
    ...
    <div class="row justify-content-center align-content-center">
      <div class="card o-hidden border-0 shadow-md" style="min-width: 45%">
       <div class="p-5">
        ...
        <form class="user" action="transactions/process.php" method="POST">
          <div class="form-group">
            <input name="user_mail" required type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder=" E-Mail ">
          </div>
          <div class="form-group">
            <input type="password" required name="user_password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Şifre">
          </div>
          <button name="oturumac" type="submit" class="btn text-white btn-primary btn-user btn-block">Oturum Aç</button>
          <hr>           
          <p class="text-muted text-center"><?php echo $ayarcek['site_title'] ?></p>
        </form>
      </div>
    </div>
  </div>
